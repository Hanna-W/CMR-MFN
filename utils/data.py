...
from utils.dataset import UESTC_MMEA_CL
from transforms import ArrayToTensor, DataStack, GroupNormalize, IdentityTransform, ImgStack, ToTorchFormatTensor, \
...
class iUESTC_MMEA_CL(iData):
    ...
    def download_data(self):
        ...
        train_set = UESTC_MMEA_CL(self.train_list)
        test_set = UESTC_MMEA_CL(self.test_list)
